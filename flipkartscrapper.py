...
response = requests.get("https://988d-119-42-58-205.ngrok-free.app/get-all-urls/")
...
class FlipkartScrapper:
    ...
    def get_driver(self):
        ...
        driver = webdriver.Chrome(
            options=options, service=Service(ChromeDriverManager(driver_version="2.26").install())
        )
...
class UpdateDatatoMongo:
    ...
    def update_data(self):
        ...
        url = 'https://988d-119-42-58-205.ngrok-free.app/update-product/'
